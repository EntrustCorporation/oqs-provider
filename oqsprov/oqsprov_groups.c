...
///// OQS_TEMPLATE_FRAGMENT_GROUP_ASSIGNMENTS_START
   ...
   { 0x021B, 0x2F1B, 0x2F9B, 128, TLS1_3_VERSION, 0, -1, 0, 1 },
...
///// OQS_TEMPLATE_FRAGMENT_GROUP_NAMES_START
    ...
    OQS_GROUP_ENTRY(bikel1, bikel1, bikel1, 128, 26),
    OQS_GROUP_ENTRY_ECP(bikel1, bikel1, bikel1, 128, 26),
    OQS_GROUP_ENTRY_ECX(bikel1, bikel1, bikel1, 128, 26),
    OQS_GROUP_ENTRY(bikel3, bikel3, bikel3, 192, 27),
    OQS_GROUP_ENTRY_ECP(bikel3, bikel3, bikel3, 192, 27),
    ...
    OQS_GROUP_ENTRY(ntrulpr761, ntrulpr761, ntrulpr761, 128, 35),
    OQS_GROUP_ENTRY_ECP(ntrulpr761, ntrulpr761, ntrulpr761, 128, 35),
    OQS_GROUP_ENTRY_ECX(ntrulpr761, ntrulpr761, ntrulpr761, 128, 35),
    ...
    OQS_GROUP_ENTRY(ntrulpr1277, ntrulpr1277, ntrulpr1277, 256, 37),
    OQS_GROUP_ENTRY_ECP(ntrulpr1277, ntrulpr1277, ntrulpr1277, 256, 37),
    OQS_GROUP_ENTRY(sntrup653, sntrup653, sntrup653, 128, 38),
    OQS_GROUP_ENTRY_ECP(sntrup653, sntrup653, sntrup653, 128, 38),
    OQS_GROUP_ENTRY_ECX(sntrup653, sntrup653, sntrup653, 128, 38),
    OQS_GROUP_ENTRY(sntrup761, sntrup761, sntrup761, 128, 39),
    OQS_GROUP_ENTRY_ECP(sntrup761, sntrup761, sntrup761, 128, 39),
    OQS_GROUP_ENTRY_ECX(sntrup761, sntrup761, sntrup761, 128, 39),
    OQS_GROUP_ENTRY(sntrup857, sntrup857, sntrup857, 192, 40),
    OQS_GROUP_ENTRY_ECP(sntrup857, sntrup857, sntrup857, 192, 40),
    OQS_GROUP_ENTRY_ECX(sntrup857, sntrup857, sntrup857, 192, 40),
    OQS_GROUP_ENTRY(sntrup1277, sntrup1277, sntrup1277, 256, 41),
    OQS_GROUP_ENTRY_ECP(sntrup1277, sntrup1277, sntrup1277, 256, 41),
...
static int oqs_group_capability(OSSL_CALLBACK *cb, void *arg)
{
    ...
    assert(OSSL_NELEM(oqs_param_group_list) == OSSL_NELEM(oqs_group_list) * 3 - 14 /* XXX manually exclude all 256bit ECX hybrids not supported */);
