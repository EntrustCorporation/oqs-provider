...
MAKE_DECODER("p256_dilithium2_aes", p256_dilithium2_aes, oqsx, PrivateKeyInfo);
MAKE_DECODER("p256_dilithium2_aes", p256_dilithium2_aes, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("rsa3072_dilithium2_aes", rsa3072_dilithium2_aes, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("p384_dilithium3_aes", p384_dilithium3_aes, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("p521_dilithium5_aes", p521_dilithium5_aes, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("p256_rainbowIclassic", p256_rainbowIclassic, oqsx, PrivateKeyInfo);
MAKE_DECODER("p256_rainbowIclassic", p256_rainbowIclassic, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("rsa3072_rainbowIclassic", rsa3072_rainbowIclassic, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("p256_sphincsharaka128frobust", p256_sphincsharaka128frobust, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("rsa3072_sphincsharaka128frobust", rsa3072_sphincsharaka128frobust, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("p256_sphincssha256128frobust", p256_sphincssha256128frobust, oqsx, PrivateKeyInfo);
MAKE_DECODER("p256_sphincssha256128frobust", p256_sphincssha256128frobust, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("rsa3072_sphincssha256128frobust", rsa3072_sphincssha256128frobust, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("p256_sphincsshake256128frobust", p256_sphincsshake256128frobust, oqsx, PrivateKeyInfo);
...
MAKE_DECODER("dilithium5_falcon1024", dilithium5_falcon1024, oqsx, PrivateKeyInfo);
MAKE_DECODER("dilithium5_falcon1024", dilithium5_falcon1024, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("p521_rsa3072", p521_rsa3072, oqsx, PrivateKeyInfo);
MAKE_DECODER("p521_rsa3072", p521_rsa3072, oqsx, SubjectPublicKeyInfo);
