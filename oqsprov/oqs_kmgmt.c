...
{
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx), OQS_SIG_alg_dilithium_5, "dilithium5_falcon1024", KEY_TYPE_CMP_SIG, NULL, 128);
}

static void *dilithium5_falcon1024_gen_init(void *provctx, int selection)
{
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_dilithium_5, "dilithium5_falcon1024", KEY_TYPE_CMP_SIG, 128);
}

static void *p521_rsa3072_new_key(void *provctx)
{
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx), "p521", "p521_rsa3072", KEY_TYPE_CMP_SIG, NULL, 128);
}

static void *p521_rsa3072_gen_init(void *provctx, int selection)
{
    return oqsx_gen_init(provctx, selection, "p521", "p521_rsa3072", KEY_TYPE_CMP_SIG, 128);
}
